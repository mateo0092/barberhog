...
;(function($) {
   ...
   'use strict'
		...
		function sliderHeight() {
			...
			$('#slideshow').imagesLoaded( function() {
				if ( $(window).width() <= 1024 ){	
					...
					$('.barberhog-hero-area, #slideshow').height(slideItemHeight);
				} else {
					$('.barberhog-hero-area').css('height', 'auto');
				}
			});
		}
	...
	var videoPopup = function() {
		...
		function closePopup() {
			if ( $('.barberhog-video.vid-lightbox .video-overlay').hasClass('popup-show') ) {
			    
				var popup = $('.barberhog-video.vid-lightbox .video-overlay.popup-show');
		...
		$('.barberhog-video.vid-lightbox .video-overlay').on('click',function () {
			closePopup();
		});

		$('.barberhog-video.vid-lightbox').parents('.panel-row-style').css({'z-index': '12', 'overflow': 'visible'});	
