...
barberhog, Copyright 2015
barberhog is licensed under GNU General Public License V2 or later. You can find a copy of it in the license.txt file.
...
c) Icons
The icon set used in barberhog is FontAwesome.
...
Theme documentation is available on http://athemes.com/documentation/barberhog/
