...
class barberhog_Action extends WP_Widget {

	public function __construct() {
		$widget_ops = array('classname' => 'barberhog_action_widget', 'description' => __( 'Display a call to action block.', 'barberhog') );
        parent::__construct(false, $name = __('barberhog FP: Call to action', 'barberhog'), $widget_ops);
		$this->alt_option_name = 'barberhog_action_widget';
    }
	...
	<p><label for="<?php echo $this->get_field_id('action_text'); ?>"><?php _e('Enter your call to action.', 'barberhog'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_link'); ?>"><?php _e('Link for the button', 'barberhog'); ?></label>
	...
	<p><label for="<?php echo $this->get_field_id('action_btn_text'); ?>"><?php _e('Title for the button', 'barberhog'); ?></label>
	...
	<label for="<?php echo $this->get_field_id( 'inline' ); ?>"><?php _e( 'Display the button inline with the text?', 'barberhog' ); ?></label></p>
	<?php
	}
