...
//Slider template
if ( ! function_exists( 'barberhog_slider_template' ) ) :
function barberhog_slider_template() {
    ...
    $button     = barberhog_slider_button();
    $mobile_slider = get_theme_mod('mobile_slider', 'responsive');

    //Slider text
    if ( !function_exists('pll_register_string') ) {
    	$titles = array(
    		'slider_title_1' => get_theme_mod('slider_title_1', 'Welcome to barberhog'),
    	...
    	$titles = array(
    		'slider_title_1' => pll__( get_theme_mod('slider_title_1', 'Welcome to barberhog') ),
    ...
    $images = array(
    		...
    		'slider_image_3' => get_theme_mod('slider_image_3', get_template_directory_uri() . '/images/3.jpg'),
    		'slider_image_4' => get_theme_mod('slider_image_4', get_template_directory_uri() . '/images/4.jpg'),
    ...
    <div id="slideshow" class="header-slider" data-speed="<?php echo esc_attr($speed); ?>" data-mobileslider="<?php echo esc_attr($mobile_slider); ?>">
        ...
        <?php foreach ( $images as $image ) {
        	if ( $image ) {
                ...
                $image_alt = barberhog_get_image_alt( $image );
        		?>
                <div class="slide-item" style="background-image:url('<?php echo esc_url( $image ); ?>');">
                    ...
                    <div class="slide-inner">
                        ...
                        <?php if(esc_html( $titles['slider_title_' . $c] ) !== "" || esc_html( $subtitles['slider_subtitle_' . $c] ) !== ""){ ?>
                            <style type="text/css">
                                .slides-img-header{display: none;}
                            </style>
                        <?php } else{ ?>
                            <style type="text/css">
        ...
        <?php if ( $text_slide ) : ?>
            <?php echo barberhog_stop_text(); ?>
        <?php endif; ?>
        <div class="slides-img-header">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/header_logo.png');?>" alt="">
            <img src="<?php echo esc_url(get_template_directory_uri() . '/images/header_subtitle.png');?>" alt="">
        </div>
    </div>
...
function barberhog_slider_button() {
...
function barberhog_stop_text() {
    ...
    <div class="slide-inner text-slider-stopped">
        ...
        <?php echo barberhog_slider_button(); ?>
    </div>   
    <?php 
}